...
export function ComprarProduto() {
  ...
  const enderecoSelecionado = enderecos[0];
              ...
              {formVisivel ? (
                <div className="formularioEndereco">
                  <div className="formularioContainer">
                    ...
                    <input type="text" value={rua} onChange={(e) => setRua(e.target.value)} placeholder="Rua" className="inputEndereco" />
                    <input type="text" value={numero} onChange={(e) => setNumero(e.target.value)} placeholder="Número" className="inputEndereco" />
                    <input type="text" value={referencia} onChange={(e) => setReferencia(e.target.value)} placeholder="Referência" className="inputEndereco" />
                    <input type="text" value={cidade} onChange={(e) => setCidade(e.target.value)} placeholder="Cidade" className="inputEndereco" />
                    <input type="text" value={bairro} onChange={(e) => setBairro(e.target.value)} placeholder="Bairro" className="inputEndereco" />
