      ...
      <div className="resumoProdutos">
        ...
        <div className='produtoCarrinho'>
          ...
          <div className="checkbox-wrapper-30">
            ...
            {/* Ícone SVG escondido para o checkbox */}
        ...
        {/* Preço total do produto considerando a quantidade */}
        <div className='preco'>
        ...
        <div className='quantidade'>
          <div className='botaoQuantidade'>
            ...
            {/* Botão para diminuir quantidade, sem permitir valor menor que 1 */}
            <button onClick={() => {
...
// Validação dos tipos das props recebidas
